...
<link rel="stylesheet" type="text/css" media="all" href="<?= $theme ?>/assets/css/base.css?v=<?= $hash; ?>" />
<link rel="stylesheet" type="text/css" media="all" href="<?= $theme ?>/assets/css/tablet.css?v=<?= $hash; ?>" />
<link rel="stylesheet" type="text/css" media="all" href="<?= $theme ?>/assets/css/desktop.css?v=<?= $hash; ?>" />
